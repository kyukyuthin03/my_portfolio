      ...
      <div className="mx-auto grid w-full max-w-6xl gap-12 px-5 py-10 lg:grid-cols-[1.25fr_0.95fr] lg:items-center lg:px-8 lg:py-28">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3">
            <a className="inline-flex items-center justify-center rounded-2xl bg-(--primary) px-5 py-3 font-semibold text-white shadow-[0_15px_35px_rgba(255,107,107,0.28)] transition hover:-translate-y-0.5 hover:opacity-95" href="/assets/CV.pdf" download>
              My Resume
            </a>
            <a
          ...
          <div className="rounded-full border border-(--border) bg-(--surface) p-4 shadow-[0_25px_80px_rgba(0,0,0,0.12)]">
            <div style={{ backgroundImage: 'var(--gradient)' }} className="rounded-full p-1">
              <img
                ...
                className="aspect-square w-[min(82vw,24rem)] rounded-full object-cover"
              />
            </div>
          </div>
        </div>
